...
import dev.shahab.shahab_bsef14a006.views.adapter.ProfileAdapter;
...
public class ViewProfilesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProfileAdapter adapter = new ProfileAdapter(this, UserModel.userModels);
        list.setAdapter(adapter);

        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(ViewProfilesActivity.this, ProfileDetailsActivity.class);
